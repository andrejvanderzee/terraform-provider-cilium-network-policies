...
import (
	...
	cnp "github.com/andrejvanderzee/terraform-provider-cilium-network-policies/cilium-network-policies"
	framework "github.com/andrejvanderzee/terraform-provider-cilium-network-policies/internal/framework/provider"
	manifest "github.com/andrejvanderzee/terraform-provider-cilium-network-policies/manifest/provider"
)
